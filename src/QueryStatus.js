  ...
  const handleSubmitResponses = async (e) => {
    ...
    try {
      const payload = {
        ...
        day: currentDay,
        responses: {
          breakfast: responses.breakfast === 100 ? 100 : 0,
          lunch: responses.lunch === 100 ? 100 : 0,
          dinner: responses.dinner === 100 ? 100 : 0,
          exercise: responses.exercise === 100 ? 100 : 0,
        },
      };

      await fetch('http://127.0.0.1:8000/user/submit-activity/', {
        method: 'POST',
        headers: {
